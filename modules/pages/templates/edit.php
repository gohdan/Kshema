...
<tr><td>Название (английскими буквами, например - page):</td><td><input type="text" name="name" value="#name#"></td></tr>
<tr><td>Название в меню:</td><td><input type="text" name="title" value="#title#"></td></tr>
